...
/**
 * Class RegistrationsListTable
 */
class RegistrationsListTable extends \WP_List_Table {
	...
	public function prepare_items() {
		...
		$total_items  = Registration::count_all();
		...
		$this->items = Registration::get_all( $per_page, ( $current_page - 1 ) * $per_page, $orderby, $order );
